 ...
 * O usuario dá un valor de mes e e marca e mostramos o número de ventas totais
 */

package matrizVentaCoches;
import java.util.Scanner;
import java.math.*;
public class MatrizVentaCoches07 {
	public static void main(String[]args) {
		...
		int indmes, indcoche, mes = 0, ventas = 0, marca = 0;
		...
		do {
			...
			ventas = mventacoches[mes-1][marca-1];
			
		System.out.print("As unidades vendidas no "+mes+"º mes da marca "+marca+" foron "+ventas);
		}
	}
